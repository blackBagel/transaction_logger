...
Appends printer transactions to a log file

optional arguments:
  -h, --help            show this help message and exit
  -n NUM_TRANSACTIONS, --num-transactions NUM_TRANSACTIONS
                        the number of transactions to be printed (default: 3)
  -o OUTPUT_FILE, --output-file OUTPUT_FILE
                        The path for the log created by the script (default: ./transaction.log)
  -s DAYS_BACK, --days-back DAYS_BACK
                        How many days back should the log start its' timestamp (default: 2)
  -d MAX_DURATION, --max-duration MAX_DURATION
                        Maximal duration of a single transaction in seconds (default: 86400)
  ...
  -b DB_ERROR_CHANCE, --db-error-chance DB_ERROR_CHANCE
                        0 to 1 chance there will be a problem with the connection to the DB at the beginning of the transaction (default: 0.2)
  ...
  -r SERVERS_AMOUNT, --servers-amount SERVERS_AMOUNT
                        Number of possible different servers to use (default: 7)
